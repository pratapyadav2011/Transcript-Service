...
def transcribe_url_task(
    ...
    try:
        ...
        # Fast-path: reuse existing captions/subtitles instead of downloading and
        # transcribing audio. If none exist, continue to the selected engine.
        ...
        if is_youtube_url(url):
            ...
            # OAuth 401 while its embedded player exposes subtitles normally.
                ...
                job_id, log, candidates[0], meeting_id, transcript_id, actor
            )
        if done is not None:
            return done
